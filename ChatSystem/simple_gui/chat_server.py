...
class Server:
    def __init__(self):
        ...
        self.indices = {}
        # sonnet
        self.sonnet = indexer.PIndex("Chat-System/ChatSystem/AllSonnets.txt")
...
# ==============================================================================
                ...
                if from_name in self.indices:
                    self.indices =[from_name].add_msg(from_name, message)
                # ---- end of your code --- #
...
# ==============================================================================
                ...
                # IMPLEMENTATION
                # ---- start your code ---- #
                list_result = str(self.group)
                mysend(from_sock, json.dumps({"action" : "list", "list": list_result}))
...
# ==============================================================================
                ...
                # IMPLEMENTATION
                # ---- start your code ---- #
                sonnet_number = msg.get("target")
                try: 
                    sonnet_num = int(sonnet_num)
                    poem = self.sonnet.get_poem(sonnet_num)
                except IndexError:
                    poem = "Sonnet numnber out of range"
                except ValueError:
                    poem = "Invalid sonnet number"
                except AttributeError:
                    poem = "Sonnet functionality not avaliable"
                print('here:\n', poem)
